...
import com.app.astart.domain.PurchaseItem;
import com.app.astart.persistence.entity.Compra;
import com.app.astart.persistence.entity.ComprasProducto;
...
@Generated(
    ...
    date = "2023-02-26T22:06:03-0500",
    comments = "version: 1.5.3.Final, compiler: IncrementalProcessingEnvironment from gradle-language-java-7.6.jar, environment: Java 17.0.5 (Private Build)"
)
@Component
public class PurchaseMapperImpl implements PurchaseMapper {
    ...
    public Purchase toPurchase(Compra compra) {
        ...
        if ( compra.getIdCliente() != null ) {
            purchase.setClientId( Integer.parseInt( compra.getIdCliente() ) );
        }
        purchase.setDate( compra.getFecha() );
        purchase.setPayMethod( compra.getMedioPago() );
    ...
    public Compra toCompra(Purchase purchase) {
        ...
        if ( purchase.getClientId() != null ) {
            compra.setIdCliente( String.valueOf( purchase.getClientId() ) );
        }
        compra.setFecha( purchase.getDate() );
        compra.setMedioPago( purchase.getPayMethod() );
